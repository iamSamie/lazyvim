local function apply_darcula_overrides()
  ...
  set(0, "Normal", { fg = "#A9B7C6", bg = "#2B2B2B" })
  set(0, "NormalNC", { fg = "#A9B7C6", bg = "#2B2B2B" })
  ...
  set(0, "@property", { fg = "#9377A7" })
  set(0, "@field", { fg = "#9377A7" })
  ...
  set(0, "@lsp.type.property", { fg = "#9377A7" })
  set(0, "@lsp.type.enumMember", { fg = "#9377A7" })
  ...
  set(0, "NeoTreeTitleBar", { fg = "#A9B7C6", bg = "#313335", bold = false })
  set(0, "NeoTreeTabActive", { fg = "#A9B7C6", bg = "#313335", bold = true })
  set(0, "NeoTreeTabInactive", { fg = "#A9B7C6", bg = "#2B2D30" })
  set(0, "NeoTreeTabSeparatorActive", { fg = "#313335", bg = "#313335" })
  set(0, "NeoTreeTabSeparatorInactive", { fg = "#2B2D30", bg = "#2B2D30" })
  ...
  set(0, "BufferLineOffsetBackground", { fg = "#A9B7C6", bg = "#313335" })
  set(0, "BufferLineOffsetSeparator", { fg = "#4B4E52", bg = "#313335" })
